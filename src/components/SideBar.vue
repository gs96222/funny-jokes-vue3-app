...
<template>
  <div className="container-item">
    <h1 className="title"><span>Funny</span> Jokes</h1>
    <img src="@/assets/funny-emoji.svg" alt="Laugh Emoji" />
    <button @click="onClick" className="fetcher">Fetch Jokes</button>
  </div>
</template>
...
.title {
  ...
  text-shadow: 2px 2px 8px rgba(0, 0, 0, 0.692);
}
.title span {
  font-weight: 700;
  letter-spacing: 0;
